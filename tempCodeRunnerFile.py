...
# Define tokens for Python syntax
tokens = (
    'WHILE',
    'DEF',
    'CLASS',
...
# More complex tokens defined as functions
def t_WHILE(t):
    r'while'
    return t
...
def p_if_stmt(p):
    '''if_stmt : IF expr COLON suite
               | IF expr COLON suite elif_stmts
               | IF expr COLON suite ELSE COLON suite'''

def p_elif_stmts(p):
    '''elif_stmts : ELIF expr COLON suite
                  | ELIF expr COLON suite elif_stmts'''
